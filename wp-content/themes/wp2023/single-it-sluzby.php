							...
							<div class="row">
								<div class="head col-md-4">
									...
									<div class="glide-nav">
										<div class="glide__arrows" data-glide-el="controls">
											<div class="prev glide__arrow glide__arrow--left cursor-hover"
												 data-glide-dir="<">
												<?= get_icon('arr-l'); ?>
											</div>
											<div class="next glide__arrow glide__arrow--right cursor-hover"
												 data-glide-dir=">">
												<?= get_icon('arr-r'); ?>
											</div>
										</div>
								...
								<div class="list col-md-8">
									<div class="case-slider-wrap">
										...
										<? if ($cases->have_posts()) { ?>
											<div class="case-slider" id="case-slider" data-slides="2"
												 data-slides-desktop="2" data-slides-tablet="2" data-slides-phablet="2"
												 data-slides-mobile="1" data-focus="0" data-gap="40"
												 data-animation-phablet="0" data-type="slider" data-swipe="false">
										...
										<?php while (have_rows('faq')) {
											...
											<div class="item">
												<div class="item-head">
													...
													<img class="faq-close"
														 src="<?= get_template_directory_uri(); ?>/static/filles/faq-close.svg"
														 alt="">
													<img class="faq-active"
														 src="<?= get_template_directory_uri(); ?>/static/filles/faq-active.svg"
														 alt="">
												</div>
						...
						<div class="col-12">
							<div class="teaser-content">
								...
								<a href="#kontakt" class="links no-underline center-auto">
									<button class="button green normal-size hover"><span class="button__text">Domluvit schůzku</span>
									</button>
								</a>
							</div>
						</div>
										...
										<div class="item-inner">
											<div class="img">
												...
												<img data-src="<?= esc_url($img_src); ?>"
													 ...
													 sizes="(min-width: 1490px) 238px, (min-width: 1200px) 182px, (min-width: 992px) 146px, (min-width: 768px) 210px, (min-width: 576px) 240px, 100vw"
													 alt="<?= get_sub_field('nadpis'); ?>" class="lazyload">
											</div>
											<div class="text">
												<div class="head">
									...
									<div class="item-inner">
										...
										<div class="item-desc">
											...
											<? if (have_rows('price_list-usp')) { ?>
												<ul>
													<? while (have_rows('price_list-usp')) {
														the_row(); ?>
														<li><img class="faq-close"
																 src="<?= get_template_directory_uri(); ?>/static/filles/price-shop-icon.svg"
																 alt=""><?= get_sub_field('price-usp'); ?></li>
													<? } ?>
												</ul>
											<? } ?>
										</div>
									...
									<div class="item col-12 col-md-6 col-lg-4">
										<div class="item-inner">
											...
											<? if (have_rows('s-data-list-2')) { ?>
												<ul>
													<? while (have_rows('s-data-list-2')) {
														the_row(); ?>
														<li><img class="faq-close"
																 src="<?= get_template_directory_uri(); ?>/static/filles/price-shop-icon.svg"
																 alt=""><?= get_sub_field('s-data-list-row'); ?></li>
													<? } ?>
												</ul>
											<? } ?>
										</div>
													...
													<div class="img">
														...
														<a href="<?= $image['url']; ?>">
															<img data-src="<?= esc_url($img_src); ?>"
																 data-srcset="<?= esc_attr($img_srcset); ?>"
																 sizes="(min-width: 1490px) 238px, (min-width: 1200px) 182px, (min-width: 992px) 146px, (min-width: 768px) 210px, (min-width: 576px) 240px, 100vw"
																 alt="<?= get_sub_field('jmeno'); ?>" class="lazyload">
														</a>
													</div>
												</div>
											<? } ?>
